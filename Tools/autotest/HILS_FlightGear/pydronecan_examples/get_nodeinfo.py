...
from dronecan import uavcan, ardupilot
...
parser.add_argument("--target-node-id", default=10, type=int, help="target CAN node ID")
...
while True:
    try:
        ...
        if now - last_req > 1.0/args.rate:
            ...
            #req = ardupilot.indication.NotifyState.Request(timeout_sec=0.5)
